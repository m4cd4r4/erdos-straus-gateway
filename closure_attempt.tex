...
$t_7 \in \{3, 5, 6\} \subseteq S_7$, so the gateway succeeds.
\end{proof}
...
we have $|Q_A| \ge 5$.
The forced divisor only guarantees $\{f_A^0, f_A^1, f_A^2\}$
(three elements), which cannot cover all of $Q_A$ when $|Q_A| \ge 5$.
