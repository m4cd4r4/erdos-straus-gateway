...
than the condition $d \mid N$ appearing in prior work, and is essential for completeness.
...
\cite{Swett1999,ElsholtzTao2013}, and Tao~\cite{Tao2019} proved that
...
and others provide explicit decompositions for specific congruence classes.
However, no prior work has exhibited a \emph{finite} set of algebraic
identities covering all primes up to a given bound.
...
for approximately $98.75\%$ of all primes.
...
follows immediately, since the conjecture can be verified for all primes
up to~$C$ by direct computation.
...
\bibitem{Tao2019}
T.~Tao,
\emph{On the Erd\H{o}s--Straus conjecture},
unpublished note, 2019.
